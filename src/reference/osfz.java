...
public class osfz extends JFrame {
	...
	boolean bank(int a1, int b1, int c1, int a2, int b2, int c2, String pname, pocesschain w) {
		...
		for (int i = 0; i < ss; i++) {
			for (int j = 0; j < ss; j++) {
				...
				if (((pocess) w.get(j)).flag == 0 && os[0][j] + a >= ns[0][j] && os[1][j] + b >= ns[1][j]
						&& os[2][j] + c >= ns[2][j]) {
	...
	class b1a implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			pocess p = new pocess(a1.getText(), a2.getText(), a3.getText(), a4.getText(), a5.getText(), a6.getText(),
					a7.getText(), a8.getText(), a9.getText(), a10.getText(), a11.getText(), a12.getText());
	...
	class b3a implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (bank(sa, sb, sc, Integer.parseInt(a18.getText()), Integer.parseInt(a19.getText()),
					Integer.parseInt(a20.getText()), a17.getText(), wait) == true) {
				...
				wait.cancel(Integer.parseInt(a18.getText()), Integer.parseInt(a19.getText()),
						Integer.parseInt(a20.getText()), a17.getText());
